...
def _template_diagonal_dimname():
    x = _diag_base().refine_names("names::N", "names::C")
    return [x], {
        "outdim": "names::C",
        "dim1": "names::N",
        "dim2": "names::C",
...
CUSTOM_TEMPLATES.update(
    {
        ...
        "diagonal.Dimname": _template_diagonal_dimname,
        ...
        "float_power_.Scalar": _template_float_power_scalar,
        ...
        "fft_hfft2.default": _template_fft_hfft,
        "fft_hfft2.out": _template_fft_hfft_out,
        "fft_hfftn.default": _template_fft_hfft,
        "fft_hfftn.out": _template_fft_hfft_out,
        ...
        "fft_ihfft2.default": _template_fft_ihfft,
        "fft_ihfft2.out": _template_fft_ihfft_out,
        "fft_ihfftn.default": _template_fft_ihfft,
        "fft_ihfftn.out": _template_fft_ihfft_out,
        "fft_irfft.default": _template_fft_irfft,
        "fft_irfft.out": _template_fft_irfft_out,
        "fft_irfft2.default": _template_fft_irfft,
        "fft_irfft2.out": _template_fft_irfft_out,
        "fft_irfftn.default": _template_fft_irfft,
        "fft_irfftn.out": _template_fft_irfft_out,
        "fft_rfft.default": _template_fft_rfft,
        "fft_rfft.out": _template_fft_rfft_out,
        "fft_rfft2.default": _template_fft_rfft,
        "fft_rfft2.out": _template_fft_rfft_out,
        "fft_rfftn.default": _template_fft_rfft,
        "fft_rfftn.out": _template_fft_rfft_out,
