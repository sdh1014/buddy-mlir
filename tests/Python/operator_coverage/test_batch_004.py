...
def _template_kthvalue_out():
    ...
    values = torch.empty(1, dtype=torch.float32)
    indices = torch.empty(1, dtype=torch.int64)
...
CUSTOM_TEMPLATES.update(
    {
        ...
        "linalg_cholesky_ex.L": _template_linalg_cholesky_ex_out,
        "linalg_cross.default": _template_linalg_cross,
        "linalg_cross.out": _template_linalg_cross_out,
        "linalg_eig.default": _template_linalg_eig_like,
        "linalg_eig.out": _template_linalg_eig_like_out,
        "linalg_eigvals.default": _template_linalg_eig_like,
        "linalg_eigvals.out": _template_linalg_eigvals_out,
        "linalg_householder_product.default": _template_linalg_householder_product,
        "linalg_householder_product.out": _template_linalg_householder_product_out,
        "linalg_inv_ex.default": _template_linalg_matrix,
        "linalg_inv_ex.inverse": _template_linalg_matrix_out,
        "linalg_ldl_factor_ex.default": _template_linalg_ldl_factor,
        "linalg_ldl_factor_ex.out": _template_linalg_ldl_factor_out,
        "linalg_ldl_solve.default": _template_linalg_ldl_solve,
        "linalg_ldl_solve.out": _template_linalg_ldl_solve_out,
        "linalg_lu.default": _template_linalg_lu,
        "linalg_lu.out": _template_linalg_lu_out,
        "linalg_lu_factor_ex.default": _template_linalg_lu_factor_ex,
        "linalg_lu_factor_ex.out": _template_linalg_lu_factor_ex_out,
        "linalg_lu_solve.default": _template_linalg_lu_solve,
        "linalg_lu_solve.out": _template_linalg_lu_solve_out,
        "linalg_matrix_exp.default": _template_linalg_matrix_exp,
        "linalg_matrix_exp.out": _template_linalg_matrix_exp_out,
        "linalg_qr.default": _template_linalg_qr,
        "linalg_qr.out": _template_linalg_qr_out,
        "linalg_solve_triangular.default": _template_linalg_solve_triangular,
        "linalg_solve_triangular.out": _template_linalg_solve_triangular_out,
        ...
        "log_normal_.default": _template_log_normal,
        "lstm.input": _template_lstm_input,
        "lstm.data": _template_lstm_data,
        "lu_unpack.default": _template_lu_unpack,
        "lu_unpack.out": _template_lu_unpack_out,
        ...
        "masked_scatter_backward.default": _template_masked_scatter_backward,
